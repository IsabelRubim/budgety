...
var UIController = (function() {
    ...
    return {
        ...
        displayPercentages: function(percentages) {
            ...
            var bar = document.querySelector(DOMstrings.barLabel);
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var loadData = function() {
        var storedData, newInc, newExp;

        // 1. load the data from the local storage
        storedData = budgetCtrl.getStoreData();
        ...
        if (storedData) {
            ...
            storedData.allItems.inc.forEach(function(cur) {
                newInc = budgetCtrl.addItem('inc', cur.description, cur.value);
                UICtrl.addListItem(newInc, 'inc');
            });

            // 4. Create the Expense Objects
            storedData.allItems.exp.forEach(function(cur) {
                newExp = budgetCtrl.addItem('exp', cur.description, cur.value);
                UICtrl.addListItem(newExp, 'exp');
            });
